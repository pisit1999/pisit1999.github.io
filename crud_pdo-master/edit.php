<?php 
    ...
    if (isset($_REQUEST['btn_update'])) {
        ...
        if (empty($firstname_up)) {
            ...
            try {
                if (!isset($errorMsg)) {
                    $update_stmt = $db->prepare("UPDATE tbl_person SET firstname = :fname_up, lastname = :lname_up, amount = :amount_up    WHERE id = :id");
    ...
    <form method="post" class="form-horizontal mt-5">
            ...
            <div class="form-group text-center">
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="txt_amount" class="form-control" value="<?php echo $amount; ?>">
                    </div>
                </div>
            </div>
            <div class="form-group text-center">
